...
inline void db_SProjImagePointPointConstraint(float c[9],int i_num,int i_den,int i_zero,
                           float xp[3],float x[3])
{
...
inline void db_SProjImagePointPointConstraints(float c1[9],float c2[9],float xp[3],float x[3])
{
    int ma_ind;
...
inline void db_SAffineImagePointPointConstraints(float c1[7],float c2[7],float xp[3],float x[3])
{
    float ct1[9],ct2[9];
...
inline void db_CommonFocalLengthFromRotation_2Point(float fsol[3],int *nr_sols,float x1[3],float x2[3],float xp1[3],float xp2[3],int signed_disambiguation=1)
{
    float m,ax,ay,apx,apy,bx,by,bpx,bpy;
    float p1[2],p2[2],p3[2],p4[2],p5[2],p6[2];
    float p7[3],p8[4],p9[5],p10[3],p11[4];
    float roots[3];
    int nr_roots,i,j;
...
{
    int i;
    float c[2],cp[2],r[2],rp[2],M[4],s,sp,sc;
    float *temp,*temp_p;
    float Aacc,Bacc,Aacc2,Bacc2,divisor,divisor2,m,Am,Bm;
